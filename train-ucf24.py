...
parser.add_argument('--stepvalues', default='50000,80000,110000', type=str, help='iter numbers where learing rate to be dropped')
...
def main():
    ...
    args.means = (104, 117, 123, 120, 120, 120)
    ...
    args.exp_name = 'CONV2-Modul-SSD-{}-{}-bs-{}-{}-lr-{:05d}'.format(args.dataset,
...
def train(args, net, optimizer, criterion, scheduler):
    ...
    while iteration <= args.max_iter:
        for i, (images, flows, targets, img_indexs) in enumerate(train_data_loader):
